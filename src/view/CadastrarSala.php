            ...
            <div class="row-fluid">
                    <div id="conteudo">
                            <div class="span12">
                                ...
                                <form id="sala" class="form-horizontal" method="POST" action="index.php?pg=InserirSala">
                                        <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input id="sala" name="sala" style="text-transform:uppercase;" placeholder="I-1 ou II-F1" class="input-small" value="" type="text">
                                          </div>
                                        </div>
                                        ...
                                        <!-- Button -->
                                        <div class="control-group">
                                          <label class="control-label" for="cadastrarsala"></label>
                                          <div class="controls">
                                            <button id="cadastrarsala" name="cadastrarsala" class="btn btn-primary">Cadastrar</button>
                                          </div>
                                        </div>
                                ...
                                <table class="table">
                                    <tr>
                                      ...
                                      <tr>          
                                        <td>'.$da->sal_nome.'</td>
                                        <td>Unidade '.$da->sal_predio.'</td>
                                        <td><a class = "btn btn-inverse" href="index.php?pg=AlterarSala&id='.$da->id.'">Editar </a></td>
                                      </tr>';
                                        }
                                        ?>
